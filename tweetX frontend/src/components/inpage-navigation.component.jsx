...
const InPageNavigation = ({ routes, defaultHidden = [], defaultActiveIndex = 0, children, setInPageState }) => {
    ...
    return (
        <>
            <div className='relative mb-8 bg-white justify-around border-t border-grey flex flex-nowrap overflow-x-auto mx-auto'>
                {
                    routes.map((route, i) => {
                        return (
                            <button
